...
func (x *StartDownloadRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *DownloadStatusResponse) GetRequestId() uint32 {
	if x != nil {
		return x.RequestId
	}
	return 0
...
var file_client_client_proto_rawDesc = string([]byte{
	...
	0x6f, 0x6d, 0x2f, 0x62, 0x6f, 0x6e, 0x65, 0x66, 0x61, 0x62, 0x72, 0x69, 0x63, 0x2f, 0x76, 0x72,
	0x61, 0x62, 0x62, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x62, 0x06,
